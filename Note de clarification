...
Remarquons d'abord que seule la base de données est attendue et non la conception de l'application web. 
...
Chaque livrable sera déposé sur Git. La communication entre la maitrise d'oeuvre et la maitrise d'ouvrage se fera par mattermost (message personnel) ainsi que mumble.
